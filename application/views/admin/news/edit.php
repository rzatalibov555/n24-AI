                            ...
                            <div class="tab-pane fade show active" id="az" role="tabpanel" aria-labelledby="az-line-tab">
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title_az" id="title_az" class="form-control" value="<?= htmlspecialchars($news['title_az'], ENT_QUOTES, 'UTF-8'); ?>" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description_az" id="short_description_az" class="form-control" rows="3" required><?= htmlspecialchars($news['short_description_az'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="long_description_az" id="long_description_az" class="form-control" rows="10" required><?= htmlspecialchars($news['long_description_az'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-line-tab">
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title_en" id="title_en" class="form-control" value="<?= htmlspecialchars($news['title_en'], ENT_QUOTES, 'UTF-8'); ?>" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description_en" id="short_description_en" class="form-control" rows="3" required><?= htmlspecialchars($news['short_description_en'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="long_description_en" id="long_description_en" class="form-control" rows="10" required><?= htmlspecialchars($news['long_description_en'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="ru-line-tab">
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title_ru" id="title_ru" class="form-control" value="<?= htmlspecialchars($news['title_ru'], ENT_QUOTES, 'UTF-8'); ?>" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description_ru" id="short_description_ru" class="form-control" rows="3" required><?= htmlspecialchars($news['short_description_ru'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="long_description_ru" id="long_description_ru" class="form-control" rows="10" required><?= htmlspecialchars($news['long_description_ru'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="video_link" id="video_link" class="form-control" value="<?= $news["video"] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="type" id="type" class="form-select">
                                        ...
                                        <option value="naxcivan" <?= $news['type'] == 'naxcivan' ? 'selected' : ''; ?>>
                                            <?= $this->lang->line("naxcivan"); ?>
                                        </option>
                                        <option value="zengezur_corridor" <?= $news['type'] == 'zengezur_corridor' ? 'selected' : ''; ?>>
